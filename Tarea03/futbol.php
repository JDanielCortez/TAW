...
<div class="row">
    <div class="large-12 columns">
        <div class="large-10 columns"><h3>CRUD Futbolistas</h3></div> <div><a href="./createFut.php" class="button radius tiny primary">Agregar futbolista</a></div>
                        ...
                        <table  style="width: 100%">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="./updateFut.php?id=<?php echo $row['id']; ?>" class="button radius tiny success">Actualizar</a>
                                        <a href="./deleteFut.php?id=<?php echo $row['id']; ?>" class="button radius tiny warning">Eliminar</a>
                                    </td>
                                </tr>
                            <?php
                                }
