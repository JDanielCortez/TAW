<?php
    ...
    if(isset($_POST) and !empty($_POST)){
       ...
       $res = $bd->updateBasquetbolista($numero, $nombre, $posicion, $carrera, $email, $numeroActual);
       ...
       $res = $bd->singleRecordBasquetbolista($numero);
    ...
    if(isset($_GET['id']) and !isset($_POST['numero'])){
        $res = $bd->singleRecordBasquetbolista($_GET['id']);
    }
...
<div class="row">
    <div class="large-12 columns">
        ...
        <div>
            <a href="./basquetbol.php" class="button radius tiny primary">Regresar</a>
        </div>
        <div class="large-12 columns" >
