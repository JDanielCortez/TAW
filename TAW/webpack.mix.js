...
mix.styles(['resources/plantilla/css/font-awesome.min.css',
        ...
        'resources/plantilla/css/style.css'], 'public/css/style.css')
    .scripts(['resources/plantilla/js/bootstrap.min.js',
        ...
        'resources/plantilla/js/template.js'], 'public/js/plantilla.js');